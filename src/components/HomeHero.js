  ...
  return (
    <section className="relative min-h-[80vh] md:min-h-[90vh] w-full overflow-hidden bg-white">
      ...
      <div className="absolute inset-0 z-0">
        <picture>
          <source media="(max-width: 768px)" srcSet="/images/smallHomeMain.png" />
          <img
      ...
      {/* Content Overlay - Bottom-aligned on mobile, center-aligned on desktop */}
      <div className="absolute inset-0 z-10 flex items-end md:items-center pb-12 md:pb-0">
        <div className="container mx-auto px-6 md:px-20 max-w-[1600px]">
          <div className="max-w-[700px] text-[#1a1a1a]">
            <h1 className="text-[32px] sm:text-[36px] md:text-[60px] lg:text-[72px] font-bold tracking-[-0.02em] uppercase leading-[1.05] mb-6 md:mb-8">
              YOU DIDN'T<br />
              COME THIS FAR<br />
              TO STOP NOW
            </h1>
            <p className="text-[18px] sm:text-[20px] md:text-[32px] lg:text-[40px] font-light leading-tight text-[#1a1a1a]">
